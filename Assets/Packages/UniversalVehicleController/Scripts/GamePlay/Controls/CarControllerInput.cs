...
namespace PG
{
    ...
    public class CarControllerInput :InitializePlayer, ICarControl
    {
        ...
        public override bool Initialize (VehicleController car)
        {
            ...
            SteeringWheelInputController.Instance.onGasPressed.AddListener(SetAcceleration);
            SteeringWheelInputController.Instance.onBrakePressed.AddListener(SetBrakeReverse);
            SteeringWheelInputController.Instance.onSteeringWheelRotate.AddListener(SetSteer);
            SteeringWheelInputController.Instance.onClutchPressed.AddListener(SetPitch);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.RIGHTBUMPER).started.AddListener(NextGear);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.LEFTBUMPER).started.AddListener(PrevGear);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Y).started.AddListener(SwitchLights);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.L2).started.AddListener(SwitchLeftTurnSignal);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.R2).started.AddListener(SwitchRightTurnSignal);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.B).started.AddListener(ActiveHandBrake);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.B).released.AddListener(DeactiveHandBrake);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.A).started.AddListener(ActiveBoost);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.A).released.AddListener(DeactiveBoost);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.X).started.AddListener(ResetCar);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter1).started.AddListener(Gear1);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter2).started.AddListener(Gear2);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter3).started.AddListener(Gear3);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter4).started.AddListener(Gear4);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter5).started.AddListener(Gear5);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter6).started.AddListener(GearMinus1);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter1).released.AddListener(Gear0);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter2).released.AddListener(Gear0);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter3).released.AddListener(Gear0);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter4).released.AddListener(Gear0);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter5).released.AddListener(Gear0);
            SteeringWheelInputController.Instance.GetButton(SteeringWheelKeyCode.Shifter6).released.AddListener(Gear0);
        ...
        private void Gear0() => SetGear(0);
        private void Gear1() => SetGear(1);
        private void Gear2() => SetGear(2);
        private void Gear3() => SetGear(3);
        private void Gear4() => SetGear(4);
        private void Gear5() => SetGear(5);
        private void GearMinus1() => SetGear(-1);
        ...
        public void ActiveHandBrake()
        {
            HandBrake = true;
        }
        
        public void DeactiveHandBrake()
        {
            HandBrake = false;
        }
