...
namespace PG
{
    ...
    public class SteeringWheelInputController : MonoBehaviour
    {
        ...
        private void CheckButtons()
        {
            ...
            {
                if(LogitechGSDK.LogiButtonTriggered((int)GameController2.FirstIndex, (int)button.inputName))
                    button.started?.Invoke();
            
                if(LogitechGSDK.LogiButtonIsPressed((int)GameController2.FirstIndex, (int)button.inputName))
                    button.performed?.Invoke();
            
                if(LogitechGSDK.LogiButtonReleased((int)GameController2.FirstIndex, (int)button.inputName))
